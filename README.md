...
A quick start project that shows how to add a [Angular Diagram](https://www.syncfusion.com/angular-components/angular-diagram) component to an Angular CLI project. This project also includes a code snippet to create nodes and connectors, join the nodes using connectors, add segments and annotations to the connectors.  
